    ...
    <div class="w-full flex flex-col">
                        ...
                        <div class="flex flex-col gap-1">
                            <div class="flex items-center gap-1">
                                <span class="font-medium text-slate-500">
                                    <span class="font-medium text-slate-400">{{ trans('forumium.you_replied_to') }}</span>
                            ...
                            <span class="text-slate-400 text-sm">
                                {{ trans('forumium.replied') }} {{ $reply->created_at->diffForHumans() }}
                            </span>
        ...
        @else
            <span class="py-3 text-slate-700 font-medium text-sm">
                {{ trans('forumium.you_havent_replied_to_any_discussions_yet') }}
            </span>
        @endif
    </div>
    @if(!$disableLoadMore)
